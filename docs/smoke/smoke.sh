#!/usr/bin/env bash
# Planted-bug smoke test for the troubleshoot-fix bug lane.
#
# Drives a real planted bug (docs/smoke/fixture/) through the lane's DETERMINISTIC
...
#
# Run: bash docs/smoke/smoke.sh        (exit 0 = every gate behaved correctly)
set -uo pipefail
